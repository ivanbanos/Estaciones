    ...
    try {
      ...
      if (
        ...
        const formasPagoData = [
          ...
          [''],
          ['Forma de Pago', 'Participaciones', 'Cantidad de Combustible (L)', 'Total ($)'],
            ...
            ? [
                ...
                },
                {
                  table: {
                    ...
                    body: [
                      ['Forma de Pago', 'Participaciones', 'Cant. Combustible (L)', 'Total ($)'],
                      ...(reporteData.consolidadoFormaPagoOrdenes || []).map((item) => [
                        item.formaPago || '',
                        item.cantidadFacturas || 0,
                  ...
                  <div className="mt-4">
                    ...
                    <CAlert color="info" className="mb-2">
                      <small>
                        ...
                        métodos. En órdenes mixtas (2 formas), una orden puede sumar en dos filas.
                      </small>
                    </CAlert>
                    <CTable striped hover responsive>
                      <CTableHead>
                        <CTableRow>
                          ...
                          <CTableHeaderCell className="text-end">Participaciones</CTableHeaderCell>
