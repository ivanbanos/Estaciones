...
namespace FacturadorEstacionesPOSWinForm
{
    public partial class Form2 : Form
    {
        ...
        private Isla[] islas;
        public Form2(IEstacionesRepositorio estacionesRepositorio, InfoEstacion infoEstacion)
        {
        ...
        private void abrir_Click(object sender, EventArgs e)
        {
            ...
            //if(respuesta.Contains("000000ABRA"))
            //{
            //    var resultado = MessageBox.Show("¡Turno abierto!", respuesta, MessageBoxButtons.OK);

            //    this.Close();
            //} else
            //{
            //    var resultado = MessageBox.Show("¡Error abriendo turno!", respuesta, MessageBoxButtons.OK);
