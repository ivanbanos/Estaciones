...
CREATE procedure [dbo].[ObtenerFacturasPorImprimir]
as
begin try
    set nocount on;
    ...
    where impresa = 0 or impresa is null
	...
	from Facturacion_Electronica.dbo.FacturasPOS
    inner join @facturasTemp tmp on tmp.id = FacturasPOS.facturaPOSId 
...
exec [getFacturaPorConsecutivo] @ventas
*/