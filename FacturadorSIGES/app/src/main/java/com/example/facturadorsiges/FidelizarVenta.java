...
public class FidelizarVenta extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fidelizar_venta);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                int idIsla = 0;
                for(Cara caraS : caras){
                    if(caraS.DESCRIPCION ==cara ){
                        idIsla = caraS.COD_CAR;
                    }
                }
                String codigoText = codigo.getText().toString();
                String trama = "FIDAGNT "+idIsla+codigoText;
                ...
                listCall.enqueue(new Callback<String>() {
                    ...
                    public void onResponse(Call<String> call, Response<String> response) {
                        ...
                        String traduccion = "";
                        if(resultado.contains("FIDAGNTP")){
                            traduccion = "VEnta fidelizada";
                        } else{
                            traduccion = "Error fidelizando venta";
                        }
        ...
        final FidelizarVenta thisActivity = this;
