...
public class AbrirTurno extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String trama = "000000ABR0"+idIsla+codigoText;
                ...
                listCall.enqueue(new Callback<String>() {
                    ...
                    public void onResponse(Call<String> call, Response<String> response) {
                        ...
                        String traduccion = "";
                        if(resultado.contains("000000ABRA")){
                            traduccion = "Turno abierto";
                        } else{
                            traduccion = "Error abriendo turno";
                        }
        ...
        final AbrirTurno thisActivity = this;
