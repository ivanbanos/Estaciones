...
@Component({
  selector: 'app-reporte-fiscal',
  templateUrl: './reporte-fiscal.component.html',
  styleUrls: ['./reporte-fiscal.component.sass']
})
export class ReporteFiscalComponent extends BaseComponent implements OnInit {
  ...
  generatePdf(){
    ...
    const documentDefinition = { 
      info: {
        title: 'ReporteFiscal-'+nombreEstacion+'-'+dateTitle,
        author: 'SIGES Soluciones',
        subject: 'subject of document',
        keywords: 'keywords for document',
        },
      watermark: { text: 'SIGES Soluciones', color: 'blue', opacity: 0.1, bold: true, italics: false },
      footer: function(currentPage, pageCount) { return 'SIGES Soluciones ReporteFiscal - '+nombreEstacion+' - '+currentPage.toString() + ' of ' + pageCount; },
      content: [
    ...
    pdfMake.createPdf(documentDefinition).download('ReporteFiscal - '+nombreEstacion+' - '+dateTitle+'.pdf');
   }
